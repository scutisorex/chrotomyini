...
bvtv.stpl <- ggplot() +
  geom_density(aes(x = h.bvtv$samples$H1), fill = "#66116a", alpha = 0.5) +
  theme_bw() +
  xlim(0,1) +
  labs(y = "density", x = "lambda: bone volume fraction")

tbth.stpl <- ggplot() +
  geom_density(aes(x = h.tbth$samples$H1), fill = "#9f9ad2", alpha = 0.5) +
  theme_bw() +
  xlim(0,1) +
...
cond.stpl <- ggplot() +
  geom_density(aes(x = h.cond$samples$H1), fill = "grey", alpha = 0.5) +
  theme_bw() +
  xlim(0,1) +
