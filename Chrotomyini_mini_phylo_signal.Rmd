...
All have peak density at low values for lambda except Tb.Th, which is pretty confused. Tb.Th has the tightest correlation with mass, so I checked on what the phylogenetic signal is in mass by itself:
